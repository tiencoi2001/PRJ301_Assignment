<%-- 
    Document   : giveAdminRights
    Created on : Nov 3, 2021, 12:43:55 AM
    Author     : Vu Duc Tien
--%>
            ...
            <div class="main-container col2-left-layout">
                    ...
                    <div class="col-left sidebar col-left-first"><div class="block block-account">
                            ...
                            <div class="block-content">
                                <ul>
                                    ...
                                    <li ><a class="current" href="giveAdminRights">GIVE ADMIN RIGHTS</a></li>
                ...
                <div class="col-main">
                    <div class="my-account"><div class="page-title">
                        ...
                        <form action="giveAdminRights" method="POST">
